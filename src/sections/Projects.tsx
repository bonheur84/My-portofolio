...
const projects: Project[] = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1532187863136-543724761fdc?w=800&h=500&fit=crop',
  ...
  },
  {
    ...
    description: 'Mon portfolio professionnel développé avec React et Node.js.',
    longDescription: 'Ce portfolio est ma vitrine professionnelle en tant que développeur. Il présente mes compétences, mes projets, et mes coordonnées de manière moderne et interactive. Développé avec les dernières technologies web pour une expérience utilisateur optimale.',
    image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=800&h=500&fit=crop',
    tags: ['React', 'TypeScript', 'Node.js', 'Express', 'MySQL', 'TailwindCSS'],
    githubUrl: 'https://github.com/bonheur84/portfolio',
    liveUrl: '#',
    features: [
  ...
  },
  {
    ...
    longDescription: 'Une application de gestion de tâches personnelle avec interface moderne. Elle permet de créer, organiser et suivre ses tâches quotidiennes avec des priorités, des catégories et des dates d\'échéance. Les données sont sauvegardées localement pour une accessibilité permanente.',
    image: 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=800&h=500&fit=crop',
    tags: ['React', 'TypeScript', 'LocalStorage', 'TailwindCSS'],
    githubUrl: '#',
    liveUrl: '#',
    features: [
  ...
  {
    id: 6,
    title: 'Site E-commerce Prototype',
    description: 'Prototype de site e-commerce avec panier et gestion des produits.',
    longDescription: 'Un prototype fonctionnel de site e-commerce développé pour apprendre les bases du commerce en ligne. Il inclut une galerie de produits, un système de panier, et une interface d\'administration simulée pour la gestion des produits.',
